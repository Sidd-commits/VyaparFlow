          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 border-b border-slate-100">
            ...
            <div className="flex items-center gap-2.5">
              <span className="text-xs font-bold px-3 py-1 rounded-full bg-blue-50 text-blue-800 border border-blue-200 flex items-center gap-1.5">
                ...
                Status: {activeShipment?.status || 'Draft Preparation'}
              </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
            <div className="p-4 rounded-2xl bg-[#FAF9F6] border border-slate-200 space-y-1">
              ...
              <strong className="block text-slate-900 text-sm font-bold truncate">
                {activeShipment?.product.name || 'Sonaka Table Grapes (10 MT)'}
              </strong>
              <span className="text-[11px] text-slate-500">
                Quantity: {activeShipment?.quantity || 10} {activeShipment?.product.unit || 'MT'}
              </span>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-[#FAF9F6] border border-slate-200 space-y-1">
              ...
              <strong className="block text-slate-900 text-sm font-bold truncate">
                {activeShipment?.destinationCity || 'Jebel Ali'}, {activeShipment?.destinationCountry.name || 'UAE'}
              </strong>
              <span className="text-[11px] text-slate-500">
            ...
            <div className="p-4 rounded-2xl bg-[#FAF9F6] border border-slate-200 space-y-1">
              ...
              <strong className="block text-orange-700 text-sm font-bold">
                {activeShipment?.quotes.some((q) => q.isSelected) ? '✓ Provider Quote Selected' : '3 Carrier Quotes Available'}
              </strong>
              <span className="text-[11px] text-slate-500">
